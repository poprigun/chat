...
class m150818_115092_poprigun_chat_message_table extends Migration
{
    public function up()
    {
        ...
        $this->createIndex('idx-poprigun_chat_message-user_id','{{%poprigun_chat_message}}','user_id');
        ...
        $this->addForeignKey('fk-poprigun_chat_message-user_id', '{{%poprigun_chat_message}}', 'user_id', '{{%user}}', 'id','CASCADE','CASCADE');
    ...
    public function down()
    {
        ...
        $this->dropForeignKey('fk-poprigun_chat_message-user_id', '{{%poprigun_chat_message}}');
