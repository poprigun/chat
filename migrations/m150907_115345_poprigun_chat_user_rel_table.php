...
class m150907_115345_poprigun_chat_user_rel_table extends Migration
{
    public function up()
    {
        ...
        $this->addForeignKey('fk-poprigun_chat_user_rel-chat_user_id', '{{%poprigun_chat_user_rel}}', 'chat_user_id', '{{%poprigun_chat_user}}', 'id','CASCADE','CASCADE');
    }
    public function down()
    {
        $this->dropForeignKey('fk-poprigun_chat_user_rel-message_id', '{{%poprigun_chat_user_rel}}');
        $this->dropForeignKey('fk-poprigun_chat_user_rel-chat_user_id', '{{%poprigun_chat_user_rel}}');
